 ...
 *
 * @param config Pointer to the configuration structure that will be used by the server.
 *
 ...
 *
 * @param seconds_between_checks The delay in seconds between each configuration check.
 *
 * @note The function runs indefinitely until the configuration is received.
 * @warning This function should be used with caution in tasks to avoid blocking execution unnecessarily.
 */
