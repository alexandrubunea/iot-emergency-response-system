...
export async function getMalfunctions(_: Request, res: Response) {
    const API_KEY = process.env.COMMUNICATION_NODE_API_KEY;
    const API_HOST = process.env.COMMUNICATION_NODE_HOST;
    ...
    try {
        ...
        const response = await axios.get(`${API_HOST}/api/malfunctions`, {
            method: "GET",
            headers: {
                Authorization: `Bearer ${API_KEY}`,
            },
        ...
        let malfunctions = provideUniqueIdentifier(response.data)["data"];
...
export async function getDeviceLogs(_: Request, res: Response) {
    const API_KEY = process.env.COMMUNICATION_NODE_API_KEY;
    const API_HOST = process.env.COMMUNICATION_NODE_HOST;
    ...
    try {
        ...
        let deviceLogs = provideUniqueIdentifier(response.data)["data"];
        res.json(deviceLogs);
    } catch (error) {
        console.log(error);
...
export async function resetAlerts(req: Request, res: Response) {
    const API_KEY = process.env.COMMUNICATION_NODE_API_KEY;
    const API_HOST = process.env.COMMUNICATION_NODE_HOST;
